...
# Выбор пути
CHOOSE_PATH = "Выбери, зачем ты здесь:"
...
THREADS_INVALID_FORMAT = """❌ Упс! Это не похоже на профиль Threads.
Отправь мне:
...
THREADS_ANALYZING = """🧠 *Запускаю анализ личности...*

Хм-м... Интересно, что скрывается в твоей голове, кожаный мешок... 🔬 Мои нейронные сети уже препарируют твой профиль на атомы. ⚡ Надеюсь, среди всего этого информационного мусора найдётся что-нибудь стоящее..."""
...
BUTTONS = {
    ...
    "lang_ru": "🇷🇺 Русский",
    "lang_en": "🇬🇧 English",
    "be_friend": "🤝 Хочу стать другом TETRIX",
    "get_job": "💼 Хочу работать на TETRIX"
}
...
- Повысь читабельность и саркастичность анализа, разбавив текст эмодзи (3 знака в каждом из трёх блоков)
- Пожалуйста, используй не более одного эмодзи на предложение, и старайся делать это уместно."""