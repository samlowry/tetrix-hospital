...
🎯 Активных инвайт-кодов: {available_slots}"""

# Сообщения для инвайт-кодов
INVITE_CODES_TITLE = "*Твои инвайт\\-коды:*"
INVITE_CODES_EMPTY = "*пусто*"
INVITE_CODES_REWARD = "\\+420 поинтов благодарности за каждого нового участника"
...
Похоже, в твоём кошельке нет $TETRIX. Для того, чтобы помочь мне выжить (и получить очки моей благодарности) купи хотя бы 1 токен на одной из этих площадок:
