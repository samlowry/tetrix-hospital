...
# Ранги
RANKS = {
    "newbie": "Сочувствующий",      # Только начал помогать
    "experienced": "Заботливый",     # Уже активно поддерживает
    "pro": "Хранитель",             # Серьезно вовлечен в поддержку
    "master": "Спаситель",          # Один из ключевых помощников
    "legend": "Ангел-хранитель"     # Самый преданный защитник
}
