...
WELCOME_THREADS_CAMPAIGN = """✨ *Добро пожаловать в TETRIX AI анализ личности!*

Я с нетерпением жду возможности проанализировать ваш профиль Threads и предоставить уникальный отчет о вашей личности. Давайте начнем!
